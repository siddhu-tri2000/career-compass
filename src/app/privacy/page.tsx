  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
      ...
      <div className="space-y-8 text-[15px] leading-relaxed text-neutral-800">
        <section className="rounded-2xl bg-emerald-50 p-5 ring-1 ring-emerald-200/70">
          <h2 className="m-0 text-lg font-bold text-emerald-900">TL;DR</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-neutral-900">1. What we collect</h2>
        ...
        <section>
          <h2 className="text-xl font-bold text-neutral-900">2. What we send to Google Gemini</h2>
          <p className="mt-2">
            All CV analysis is performed by <a href="https://ai.google.dev/" target="_blank" rel="noreferrer" className="font-semibold text-indigo-700 underline">Google Gemini</a>.
            ...
            <a href="https://policies.google.com/privacy" target="_blank" rel="noreferrer" className="font-semibold text-indigo-700 underline">Google&apos;s Privacy Policy</a>.
          </p>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-xl font-bold text-neutral-900">3. What we store on our servers</h2>
          <p className="mt-2">
            We use <a href="https://supabase.com" target="_blank" rel="noreferrer" className="font-semibold text-indigo-700 underline">Supabase</a> (Postgres) for:
          </p>
          <ul className="mt-2 list-disc space-y-1 pl-5">
        ...
        <section>
          <h2 className="text-xl font-bold text-neutral-900">4. Cookies &amp; local storage</h2>
          <ul className="mt-2 list-disc space-y-1 pl-5">
        ...
        <section>
          <h2 className="text-xl font-bold text-neutral-900">6. Children</h2>
          <p className="mt-2">
      ...
      <div className="mt-12 flex flex-wrap items-center justify-between gap-3 border-t border-neutral-200 pt-6 text-sm text-neutral-500">
        <Link href="/terms" className="hover:text-neutral-800">Terms of Service →</Link>
